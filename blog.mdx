...
Scraping data from websites Netflix is not as easy as scraping data from any regular website. Netflix's website heavily [depends on JavaScript](https://medium.com/dev-channel/a-netflix-web-performance-case-study-c0bcde26a9d9), and it consists of tons of elements. Crawlee has the capability of scraping JS-heavy websites using its headless browsers, which we will discuss further in the article

Crawlee supports autoscaling, headless browser support, and efficient proxy management that helps make scraping easy.
...
This will save the titles and totalShows arrays as values in the _genre_ and _shows_ keys.
